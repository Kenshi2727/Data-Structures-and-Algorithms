...
// To find the kth largest element in an array using quick sort algorithm
/**
 * selectionProcedure-kthLargest
 * only channge=>pass value of k=n-k+1 where n is the length of the array and k is the kth largest element
 */
...
public class kthLargest {
    ...
    public static void main(String[] args) {
        ...
        printArr(arr, n);
        System.out.println(k + "th largest element is:" + quickSort(arr, 0, n - 1, n - k + 1));
        sc.close();
    }
}
